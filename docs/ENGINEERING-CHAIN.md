...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Retrieval/ranking/generation/provider adapter boundaries and system boundaries |
| ADR | [0001-production-boundaries.md](../ADRs/0001-production-boundaries.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_contract.py](../tests/test_contract.py) | Contract-focused validation at the repository boundary |
